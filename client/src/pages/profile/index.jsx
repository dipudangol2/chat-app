        ...
        <div className={`bg-[#1b1c24] h-screen flex items-center justify-center flex-col gap-10`}>
            ...
            <div className={`flex flex-col gap-10 w-[80vw] md:w-max`}>
                ...
                <div className={`grid grid-cols-2 `}>
                    ...
                    <div className='flex w-32 md:w-64 flex-col gap-5 text-white items-center justify-center '>
                        ...
                        <div className='w-full flex justify-center items-center gap-5'>
                            {
                                colors.map((color, index) => (
                                    <div
                                        key={index}
                                        className={`${color} h-8 w-8 rounded-full cursor-pointer transition-all duration-300 ${selectedColor === index ? " outline-2 outline-white/50 " : ""}`}
